...
// the loop knows when to stop sorting. It returns a boolean.
...
// contains, so that the loop knows when to stop sorting. It returns nothing.
...
// to stop sorting. It returns nothing.
...
// so that the loop knows when to stop sorting. It returns nothing.
...
// the loop knows when to stop sorting. It returns nothing.
